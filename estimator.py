...
# def model(vals, t, *args) -> List[float]:
#     """
#     Actual growth and product model.

#     :param vals: current model values.
#     :param t: time.
#     :param *args: positional arguments.

#     :return: differentials of model terms.
#     """
#     # isolate current concentrations:
#     X = vals[0]
#     S = vals[1]
...
# def least_square_calculator(params: dict) -> float:
#     """
#     Calculates the least square error for a given dataset.
...
#     course = odeint(model, 
#                     [X_data[0], S_data[0], P_data[0]/2, P_data[0]/2, P_data[0]], 
#                     t_data, 
#                     args=params)
#     X_sim = course[:, 0]
#     S_sim = course[:, 1]
...
# def plot_results(data_df: pd.DataFrame, 
#                  sim_df: pd.DataFrame) -> None:
#     """Generate a Seaborn Plot for the final modeled course.

#     :param data_df: DataFrame with input data.
#     :param sim_df: DataFrame with simulated data given the estimated parameters.
#     """
#     sns.set()
